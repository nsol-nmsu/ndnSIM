...
\subsubsection[{\texorpdfstring{async\+\_\+connect(transport\+\_\+con\+\_\+ptr, uri\+\_\+ptr, connect\+\_\+handler cb)}{async\_connect(transport\_con\_ptr, uri\_ptr, connect\_handler cb)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename config $>$ void {\bf websocketpp\+::transport\+::iostream\+::endpoint}$<$ {\bf config} $>$\+::async\+\_\+connect (
\begin{DoxyParamCaption}
\item[{{\bf transport\+\_\+con\+\_\+ptr}}]{, }
\item[{{\bf uri\+\_\+ptr}}]{, }
\item[{{\bf connect\+\_\+handler}}]{cb}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [protected]}}\hypertarget{classwebsocketpp_1_1transport_1_1iostream_1_1endpoint_a72e24fecb98d0445eb7df64d6b94a6a8}{}\label{classwebsocketpp_1_1transport_1_1iostream_1_1endpoint_a72e24fecb98d0445eb7df64d6b94a6a8}
...
\subsubsection[{\texorpdfstring{init(transport\+\_\+con\+\_\+ptr tcon)}{init(transport\_con\_ptr tcon)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename config $>$ lib\+::error\+\_\+code {\bf websocketpp\+::transport\+::iostream\+::endpoint}$<$ {\bf config} $>$\+::init (
\begin{DoxyParamCaption}
\item[{{\bf transport\+\_\+con\+\_\+ptr}}]{tcon}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [protected]}}\hypertarget{classwebsocketpp_1_1transport_1_1iostream_1_1endpoint_a9e169a6551db86bd1147b314924bd353}{}\label{classwebsocketpp_1_1transport_1_1iostream_1_1endpoint_a9e169a6551db86bd1147b314924bd353}
...
\subsubsection[{\texorpdfstring{init\+\_\+logging(alog\+\_\+type $\ast$a, elog\+\_\+type $\ast$e)}{init\_logging(alog\_type *a, elog\_type *e)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename config $>$ void {\bf websocketpp\+::transport\+::iostream\+::endpoint}$<$ {\bf config} $>$\+::init\+\_\+logging (
\begin{DoxyParamCaption}
\item[{{\bf alog\+\_\+type} $\ast$}]{a, }
\item[{{\bf elog\+\_\+type} $\ast$}]{e}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [protected]}}\hypertarget{classwebsocketpp_1_1transport_1_1iostream_1_1endpoint_a0c3fbf85313521d6d3a9a53faa2084ae}{}\label{classwebsocketpp_1_1transport_1_1iostream_1_1endpoint_a0c3fbf85313521d6d3a9a53faa2084ae}
...
\subsubsection[{\texorpdfstring{is\+\_\+secure() const}{is\_secure() const}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename config $>$ bool {\bf websocketpp\+::transport\+::iostream\+::endpoint}$<$ {\bf config} $>$\+::is\+\_\+secure (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [inline]}}\hypertarget{classwebsocketpp_1_1transport_1_1iostream_1_1endpoint_a42cfc1af42cd261b471bab53b85a2e2f}{}\label{classwebsocketpp_1_1transport_1_1iostream_1_1endpoint_a42cfc1af42cd261b471bab53b85a2e2f}
...
\subsubsection[{\texorpdfstring{register\+\_\+ostream(std\+::ostream $\ast$o)}{register\_ostream(std::ostream *o)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename config $>$ void {\bf websocketpp\+::transport\+::iostream\+::endpoint}$<$ {\bf config} $>$\+::register\+\_\+ostream (
\begin{DoxyParamCaption}
\item[{std\+::ostream $\ast$}]{o}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}\hypertarget{classwebsocketpp_1_1transport_1_1iostream_1_1endpoint_ad6db3b10406e568befba8e00ae8b6ac4}{}\label{classwebsocketpp_1_1transport_1_1iostream_1_1endpoint_ad6db3b10406e568befba8e00ae8b6ac4}
...
\subsubsection[{\texorpdfstring{set\+\_\+secure(bool value)}{set\_secure(bool value)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename config $>$ void {\bf websocketpp\+::transport\+::iostream\+::endpoint}$<$ {\bf config} $>$\+::set\+\_\+secure (
\begin{DoxyParamCaption}
\item[{bool}]{value}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}\hypertarget{classwebsocketpp_1_1transport_1_1iostream_1_1endpoint_ae6488ca0ead1ce09a60e16a896162ad5}{}\label{classwebsocketpp_1_1transport_1_1iostream_1_1endpoint_ae6488ca0ead1ce09a60e16a896162ad5}
...
\subsubsection[{\texorpdfstring{set\+\_\+shutdown\+\_\+handler(shutdown\+\_\+handler h)}{set\_shutdown\_handler(shutdown\_handler h)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename config $>$ void {\bf websocketpp\+::transport\+::iostream\+::endpoint}$<$ {\bf config} $>$\+::set\+\_\+shutdown\+\_\+handler (
\begin{DoxyParamCaption}
\item[{{\bf shutdown\+\_\+handler}}]{h}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}\hypertarget{classwebsocketpp_1_1transport_1_1iostream_1_1endpoint_a2ba3290fe7688190c2e85143f52d88cc}{}\label{classwebsocketpp_1_1transport_1_1iostream_1_1endpoint_a2ba3290fe7688190c2e85143f52d88cc}
...
\subsubsection[{\texorpdfstring{set\+\_\+write\+\_\+handler(write\+\_\+handler h)}{set\_write\_handler(write\_handler h)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename config $>$ void {\bf websocketpp\+::transport\+::iostream\+::endpoint}$<$ {\bf config} $>$\+::set\+\_\+write\+\_\+handler (
\begin{DoxyParamCaption}
\item[{{\bf write\+\_\+handler}}]{h}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}\hypertarget{classwebsocketpp_1_1transport_1_1iostream_1_1endpoint_a1db266dab8c73f4aa2e8a3bdb95ec5a3}{}\label{classwebsocketpp_1_1transport_1_1iostream_1_1endpoint_a1db266dab8c73f4aa2e8a3bdb95ec5a3}
