...
main(int argc, char* argv[])
{
  ...
  ndn::StrategyChoiceHelper::Install(nodes.Get(1), "/prefix", "/localhost/nfd/strategy/qos");
...
/*
  ndn::AppHelper producerHelper2("ns3::ndn::TokenBucket");
  // Producer will reply to all requests starting with /prefix
  producerHelper2.SetPrefix("/prefix");
  producerHelper2.SetAttribute("Capacity", StringValue("83"));
  producerHelper2.SetAttribute("FillRate", StringValue("2"));
  //producerHelper2.SetAttribute("PayloadSize", StringValue("1024"));
  producerHelper2.Install(nodes.Get(1)); // last node
*/
