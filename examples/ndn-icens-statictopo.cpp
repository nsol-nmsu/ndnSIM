...
//  ndn::GlobalRoutingHelper::CalculateAllPossibleRoutes();
  ...
  Simulator::Schedule(Seconds(120.0), ndn::LinkControlHelper::FailLink, nodes.Get(1), nodes.Get(9));
  Simulator::Schedule(Seconds(120.1), ndn::LinkControlHelper::UpLink, nodes.Get(1), nodes.Get(9));

  Simulator::Schedule(Seconds(360.0), ndn::LinkControlHelper::FailLink, nodes.Get(1), nodes.Get(9));
  Simulator::Schedule(Seconds(360.1), ndn::LinkControlHelper::UpLink, nodes.Get(1), nodes.Get(9));

  Simulator::Schedule(Seconds(600.0), ndn::LinkControlHelper::FailLink, nodes.Get(1), nodes.Get(9));
  Simulator::Schedule(Seconds(600.1), ndn::LinkControlHelper::UpLink, nodes.Get(1), nodes.Get(9));

  Simulator::Schedule(Seconds(840.0), ndn::LinkControlHelper::FailLink, nodes.Get(1), nodes.Get(9));
  Simulator::Schedule(Seconds(840.1), ndn::LinkControlHelper::UpLink, nodes.Get(1), nodes.Get(9));

/*
  Simulator::Schedule(Seconds(1080.0), ndn::LinkControlHelper::FailLink, nodes.Get(1), nodes.Get(9));
  Simulator::Schedule(Seconds(1080.1), ndn::LinkControlHelper::UpLink, nodes.Get(1), nodes.Get(9));

  Simulator::Schedule(Seconds(1320.0), ndn::LinkControlHelper::FailLink, nodes.Get(1), nodes.Get(9));
  Simulator::Schedule(Seconds(1320.1), ndn::LinkControlHelper::UpLink, nodes.Get(1), nodes.Get(9));

  Simulator::Schedule(Seconds(1560.0), ndn::LinkControlHelper::FailLink, nodes.Get(1), nodes.Get(9));
  Simulator::Schedule(Seconds(1560.1), ndn::LinkControlHelper::UpLink, nodes.Get(1), nodes.Get(9));

  Simulator::Schedule(Seconds(1800.0), ndn::LinkControlHelper::FailLink, nodes.Get(1), nodes.Get(9));
  Simulator::Schedule(Seconds(1800.1), ndn::LinkControlHelper::UpLink, nodes.Get(1), nodes.Get(9));
*/
